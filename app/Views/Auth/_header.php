    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary shadow-sm">
      <div class="container-fluid" style="padding:10px 20px;">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          <div class="navbar-nav fw-bold me-20" style="font-size: 25px;">
            <a class="nav-link" aria-current="page" href="/index.php/dashboard">DASHBOARD</a>
            <a class="nav-link" href="/jadwal">JADWAL</a>
            <a class="nav-link d-flex align-items-center" href="#" style="font-size: 20px;">
              <img src="/img/profile.png" width="20" class="me-1">USERNAME
            </a>
          </div>
        </div>
      </div>
