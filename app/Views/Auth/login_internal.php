...
<div class="login-container">
    ...
    <form action="<?= site_url('login') ?>" method="post">
        ...
        <div class="input-group">
            ...
            <input type="text" name="login" placeholder="NIM" value="<?= old('login') ?>" required>
        </div>
        ...
        <a href="<?= route_to('forgot') ?>" style="padding-left: 225px;">Lupa Password?</a><br>
        <button class="btn-login mb-2" type="submit">Login</button>

        <p>Belum punya akun PNC?
            <a href="https://bit.ly/emailstudent2" target="_blank">
                <u><i>Buat di sini</i></u>
            </a>
        </p>
    </form>
</div>
