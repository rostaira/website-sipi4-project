...
<div class="register-container">
    ...
    <form action="<?= url_to('registerInternal') ?>" method="post">
        <?= csrf_field() ?>

        <label>NIM:</label>
            <div class="input-group">
                <img src="<?= base_url('img/username.png'); ?>" class="icon-left">
                <input type="text" name="username" value="<?= old('username') ?>" placeholder="Masukkan NIM" required>
            </div>       
        <label>Email:</label>
        <div class="input-group">
            <img src="<?= base_url('img/email.png'); ?>" class="icon-left">
            <input type="email" name="email" value="<?= old('email') ?>" placeholder="*****.stu@pnc.ac.id" required>
        </div>
        ...
        <p>Sudah Punya Akun?<a href="<?= site_url('login-internal') ?>"> Login di sini</a></p>
        </div>
